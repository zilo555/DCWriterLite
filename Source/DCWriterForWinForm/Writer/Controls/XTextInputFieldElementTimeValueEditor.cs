...
namespace DCSoft.Writer.Controls
{
    ...
    internal class XTextInputFieldElementTimeValueEditor : ElementValueEditor
    {
        ...
        /// 初始化对象
        /// </summary>
        public XTextInputFieldElementTimeValueEditor()
        {
        }
        /// <summary>
        /// 获得编辑样式
            ...
            ElementValueEditContext context)
        {
            ...
            if (field.DisplayFormat != null && field.DisplayFormat.Format != null)
            {
                fieldformat = field.DisplayFormat.Format;
            }
            bool isTime = false;//判断原有内容是否是时间
            ...
            TextWindowsFormsEditorHostClass host )
        {
            ...
            else
            {
                ...
                {
                    newText = newDate.ToString(WriterConst.Format_HH_mm_ss);
                }
                {
                    newValue = newDate.ToString(WriterConst.Format_HH_mm_ss);
                }
            }
