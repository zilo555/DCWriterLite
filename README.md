...
<br />Author : yongfu-yuan(袁永福,MS MVP) from CHINA . Email:28348092@qq.com,Site:[https://dcwriter.cn/](https://dcwriter.cn/).
# update log
...
- XTextCheckBoxElement/XTextRadioElement Check box/Radio button element
  ...
  If you want more features and services, please learn about [[the DCWriter Business Edition]](https://raw.githubusercontent.com/dcsoft-yyf/DCWriterLite/refs/heads/main/README-be.md) . 
...
提供树状的DOM模型，用于表示文档中所有的内容。并提供以下DOM文档元素类型。
 ...
 - XTextCheckBoxElement/XTextRadioElement 单选框/单选按钮元素
  ...
  您若想要更多的功能和服务，请了解[[DCWriter商业版]](https://raw.githubusercontent.com/dcsoft-yyf/DCWriterLite/refs/heads/main/README-be.md).
